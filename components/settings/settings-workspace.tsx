  ...
  return (
    <section className="settings-page">
      ...
      <div className="settings-grid">
        ...
        <div className="section-card"><h3><Mail size={16} /> Email inbox</h3><p>Forward support mail to:</p><pre className="code-block">{inboundAddress || "Created automatically after workspace setup"}</pre><p className="muted">Provider webhook: <code>/api/inbound/email</code>. Resend delivery events: <code>/api/email/events</code>. Both require the configured webhook secret.</p></div>
